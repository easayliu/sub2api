<template>
  ...
  <div class="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
    <!-- Balance -->
    <div v-if="!isSimple" class="card p-3 sm:p-4">
      <div class="flex items-center gap-2.5 sm:gap-3">
        ...
        <div class="min-w-0 flex-1">
          <p class="truncate text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.balance') }}</p>
    ...
    <div class="card p-3 sm:p-4">
      <div class="flex items-center gap-2.5 sm:gap-3">
        ...
        <div class="min-w-0 flex-1">
          <p class="truncate text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.apiKeys') }}</p>
    ...
    <div class="card p-3 sm:p-4">
      <div class="flex items-center gap-2.5 sm:gap-3">
        ...
        <div class="min-w-0 flex-1">
          <p class="truncate text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.todayRequests') }}</p>
    ...
    <div class="card p-3 sm:p-4">
      <div class="flex items-center gap-2.5 sm:gap-3">
        ...
        <div class="min-w-0 flex-1">
          <p class="truncate text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.todayCost') }}</p>
  ...
  <div class="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
    ...
    <div class="card p-3 sm:p-4">
      <div class="flex items-center gap-2.5 sm:gap-3">
        ...
        <div class="min-w-0 flex-1">
          <p class="truncate text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.todayTokens') }}</p>
    ...
    <div class="card p-3 sm:p-4">
      <div class="flex items-center gap-2.5 sm:gap-3">
        ...
        <div class="min-w-0 flex-1">
          <p class="truncate text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.totalTokens') }}</p>
    ...
    <div class="card p-3 sm:p-4">
      <div class="flex items-center gap-2.5 sm:gap-3">
        ...
        <div class="min-w-0 flex-1">
          <p class="truncate text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.performance') }}</p>
    ...
    <div class="card p-3 sm:p-4">
      <div class="flex items-center gap-2.5 sm:gap-3">
        ...
        <div class="min-w-0 flex-1">
          <p class="truncate text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.avgResponse') }}</p>
