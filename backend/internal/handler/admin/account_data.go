...
func validateDataAccount(item DataAccount) error {
	...
	switch item.Type {
	case service.AccountTypeOAuth, service.AccountTypeSetupToken, service.AccountTypeAPIKey, service.AccountTypeUpstream, service.AccountTypeBedrock, service.AccountTypeAWSAnthropic:
	default:
